...
def parse_option():
    ...
    args.test_txt_path = f"/data/zjl/192-torch/pytorch-coviar-master/data/datalists/DFEW-txt/CAM.txt"
...
def main(config, args):
    ...
    #                           'model']
    "/data/zjl/192-torch2/VideoX-master/X-CLIP/Output/DFEW/DFEW_第1折_12-07日_14-26-51时/best.pth"
    "/data/zjl/192-torch2/VideoX-master/X-CLIP/Output/DFEW/DFEW_第2折_12-07日_14-25-33时/best.pth"
    "/data/zjl/192-torch2/VideoX-master/X-CLIP/Output/DFEW/DFEW_第3折_12-08日_09-23-27时/best.pth"
    "/data/zjl/192-torch2/VideoX-master/X-CLIP/Output/DFEW/DFEW_第4折_12-08日_09-24-50时/best.pth"
    "/data/zjl/192-torch2/VideoX-master/X-CLIP/Output/DFEW/DFEW_第5折_12-08日_09-33-37时/best.pth"

    #text
    model.load_state_dict(torch.load(
        "/data/zjl/192-torch2/VideoX-master/X-CLIP/Output/DFEW/DFEW_第3折_12-08日_09-23-27时/best.pth",map_location=f'cuda:0')[
                              'model'])
    ...
    save_path = "/data/zjl/192-torch2/VideoX-master/X-CLIP/save_cam_img/4CAM-fold3_-1/"
    if not os.path.exists(save_path):
        os.makedirs(save_path)
    for idx, batch_data in tqdm(enumerate(val_loader)):
        ...
        # frame_inds = [49,50,51,52,53,54,55,55]
