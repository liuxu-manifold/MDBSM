...
def update_config(config, args):
    ...
    if args.train_txt_path:
        config.DATA.TRAIN_FILE = args.train_txt_path
    if args.test_txt_path:
        config.DATA.VAL_FILE = args.test_txt_path
    if args.save_txt_path:
        config.DATA.TXT_FILE = args.save_txt_path
    if args.save_txt_path:
        last_slash_index = args.save_txt_path.rfind('/')
        # 获取 '/' 前面的部分
        parent_directory = args.save_txt_path[:last_slash_index]
        config.DATA.SAVE_CHEK_FILE = parent_directory
    if args.flod_id :
        config.DATA.FlOD = args.flod_id
